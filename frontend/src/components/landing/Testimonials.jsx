...
const principles = [
  ...
  },
  {
    ...
    text: 'Calendar, news scoring, currency strength, and COT positioning — pulled together so you walk into the session with context instead of guesswork.',
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto mb-14">
          <div className="relative bg-slate-900/40 border border-white/10 rounded-2xl p-8 md:p-10">
            ...
            <div className="flex items-center gap-3 mt-6 pt-6 border-t border-white/5">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 to-emerald-500 flex items-center justify-center text-black font-black text-sm">
                BF
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {principles.map((p) => (
            <div
              key={p.title}
              className="group bg-slate-900/40 border border-white/10 hover:border-cyan-500/30 hover:-translate-y-1 transition-all duration-300 rounded-2xl p-6 flex flex-col gap-3"
            >
        ...
        <div className="text-center mt-6">
          <a href="#pricing" className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-600 text-black font-bold text-sm hover:opacity-90 transition-opacity">
