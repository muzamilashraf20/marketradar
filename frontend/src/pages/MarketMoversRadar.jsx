...
const MOVERS = [
  ...
  { id: 'powell', name: 'Kevin Warsh', avatar: '🏦', keywords: ['warsh', 'federal reserve', 'fed chair', 'fomc', 'fed rate', 'fed interest', 'fed policy'], color: 'bg-amber-400/10 text-amber-400 border-amber-400/20', role: 'Fed Chair', affectedAssets: ['USD', 'Gold', 'Bonds', 'S&P500'] },
