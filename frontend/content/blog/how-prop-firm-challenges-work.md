...
**Ignoring the calendar.** They hold full size into a high-impact release, and slippage carries price straight through their stop, breaching a limit they never meant to approach. This is why a funded trader has to [respect the economic calendar](/blog/how-to-trade-high-impact-news) as a hard risk input, not background noise.
...
6. **Never hold full size into known event risk.** Check the calendar each session and size down — or stand aside — into high-impact releases.
